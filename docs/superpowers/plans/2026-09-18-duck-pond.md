...
**Tech Stack:** Vanilla HTML/CSS/JS. No build step, no runtime dependencies. Node 20+ only for `node --test`. Sprite sheets and audio are CC0 assets. GPL-3.0, deployed to GitHub Pages.
...
`duckpond`, how to run the tests (`node --test test/`), and the full **Asset
